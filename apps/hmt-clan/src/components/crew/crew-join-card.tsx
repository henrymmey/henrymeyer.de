...
export default function CrewJoinCard() {
  return (
    ...
    >
      <div className="relative flex aspect-[3/4] w-full shrink-0 flex-col items-center justify-center gap-4 bg-[linear-gradient(to_bottom,var(--hmt-surface-2),var(--hmt-surface))] px-5 text-center">
      ...
      <div className="relative flex flex-1 flex-col justify-end border-t border-white/5 px-3 pb-4 pt-3 text-center">
